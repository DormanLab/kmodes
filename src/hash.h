...
int add_sequence(hash **seq_count, unsigned int *seq, unsigned int length,size_t idx);
int add_seq_idx(hash *seq_count, unsigned int *seq, unsigned int length, size_t idx);
